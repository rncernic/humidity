...
const
  ...
  APPLICATION_NAME = 'Humidity';
  AUTHOR_NAME      = 'R.N. Cernic';
  COPYRIGHT        = '© 2026. All rights reserved.';
  DESCRIPTION      = 'A tiny desktop utility that computes relative humidity ' +
    'and dew point from dry-bulb temperature, wet-bulb temperature,' +
    'and elevation above sea level. Built with Free Pascal and Lazarus (LCL).';
